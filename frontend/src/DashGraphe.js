...
import { faBridge, faStethoscope, faTools } from '@fortawesome/free-solid-svg-icons';
...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (pontsResponse.ok && diagnosticsResponse.ok && interventionsResponse.ok) {
  ...
  const handleCardClick = (card) => {
    ...
    // Vous pouvez ajouter d'autres redirections si nécessaire pour les autres cartes
  };
  ...
  return (
    <div style={styles.dashboardContainer}>
      ...
      <div style={styles.chartContainer}>
        <h2>Taux d'Interventions par Année</h2>
